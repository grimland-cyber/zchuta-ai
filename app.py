...
st.markdown("<p class='app-subtitle'>איך נראה מיצוי זכויות פרואקטיבי בידן סוכני ה-AI האוטונומיים</p>", unsafe_allow_html=True)
...
<div class='feature-box' style='background: linear-gradient(135deg, #0f172a, #1e293b); color: white;'>
    <h3 style='margin-top: 0; color: #38bdf8; font-weight: 700; font-size: 16px;'>איך להסביר לאדם מהרחוב מה קורה כאן?</h3>
        <p style='font-size: 12px; color: #cbd5e1; line-height: 1.6;'>
                פעם, כדי לקבל כסף שמגיע לך מהמדינה, היי צריך לחפש שעות באינטרנט, לקרוא חוקים מסובכים, למלא טפסים ארוכים בכתב יד ולהתווכח עם פקידים.<br>
...
scenarios = {
      "🤰 ילדתי תאוים ועבדתי שתיים ברצף": {
                ...
                "fields": {
                              ...
                              "חשבון בנק לזיכוי": "בנק לאומי (10), סניף 800, \"פ 123456"
                },
                "logs": [
                              ...
                              "[RULES_DB] מצלי נונים מול תקנות 2026: ותק עולה על 10 חודשים מזכה ב-15 שבועות מלאים.",
                              ...
                              "[FORM_ENGINE] מאכלס 100% משדות טופס 356 על בסי הצלבת נתוי מעסיק ורשות המיסים.",
                              "[API_CLIENT] מבצע לחיצת יד דיגיטלית מול האזור האישי בביטוח לאומי...",
                              "[SUCCESS] התביעה מולאה בהצלחה ומוכנה לשגר!"
                ]
      },
      "🚗 התפטרתי כי עברנו דירה בשל עבודת אשתי": {
                "text": "התפטרתי מהעבודה בגלל שאשתי קיבלה הצעת עבודה בחיפה ועברנו מראש העין. עבדתי שם שנה וחצי, שר של 11,000 ש\"ח. מתי אקבל אבטלה?",
                "type": "unemployment",
                "salary": 11000,
                ...
                "fields": {
                              ...
                              "סיבת יום עבודה": "התפטרות מוצדקת (מעבר דירה בעקבות תעסוקת בת זוג)",
                              "מרחק המעבר": "84 ק\" (מעל הרף החוקי של 40 ק\"מ)",
                ...
                "logs": [
                              ...
                              "[RULES_DB] עוקף אוטומטית את תקפת השלילה של ה-90 יום ומאשר תשלום מהיום הראשו!",
                              ...
                              "[SUCCESS] הערעור ומכתב ההצדקה מולאו והתביעה מוכנה להגשה ללא תקופת המתה!"
                ]
      },
      "👴 הגעתי לגיל 67 ואני עדיין עובד": {
                ...
                "fields": {
                              "שם המוטח": "שלמה גרוניך",
                              "סוג התביעה": "קצבת אזרח ותיק (טופס 480)",
                              "גיל": "67 שנים",
                              "שר חודשי קיים": "7,200 ש\"ח (עובר מבחן הכנסה לזוג - תקרת 2026 היא 10,436 ש\"ח)",
                              "תוספ ותק מאושרת": "30% תוספת בגין 25 שנות ביטוח"
                },
                "logs": [
                              "[SYSTEM] מאתחל סוכן זכויות... זיהוי כוונה מתוך שפה חופשית.",
                              ...
                              "[CALCULATOR] קצבה בסיסית זוגי (כולל תוספת בת זוג שאינה עובדת): 2,762 ש\"ח.",
                              "[CALCULATOR] חישוב תוספת וק: 25 שנות ביטוח -> 15 שנים מעבר ל-10 הראשונות -> 15 * 2% = 30% תוספת.",
...
if st.button("🤖 הפעל את סוכן ה-AI האוטונומי"):
    ...
    st.write("#### 📄 תצוגה מקדימה של שדות הטפס המלאים:")
    ...
    st.markdown("""
        <div style='background-color: #ecfdf5; border: 1px solid #10b981; padding: 15px; border-radius: 12px; margin-top: 20px; text-align: center;'>
                <h4 style='color: #065f46; margin-top: 0;'>הכל מוכן לשיגור!</h4>
                        <p style='color: #047857; font-size: 13px;'>הסוכן חיבר את כל המסמכים המאמתים ומוכן להגש את התביה לביטוח הלאומי.</p>
                                <button style='background-color: #10b981; color: white; border: none; padding: 10px 20px; border-radius: 8px; font-weight: bold; cursor: pointer;'>שגר תביעה כעת לאזור האישי</button>
                                    </div>
                                        """, unsafe_allow_html=True)
...
3. כנס לאתר Streamlit Community Cloud, התחבר עם GitHub.
4. לחץ **New App**, בחר את התיקייה ואת הקובץ app.py ולחץ **Deploy**.
5. **זהו!** תקבל לינק ישיר שפועל מכל טלפון או מחשב.
""")
